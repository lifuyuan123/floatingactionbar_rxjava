package azsecuer.zhuoxin.com.myapplication.sdxf;
 ...
 */
public class ScrollAwareFABBehaviorss extends CoordinatorLayout.Behavior<FloatingActionsMenu> {

    private static final android.view.animation.Interpolator INTERPOLATOR=new FastOutSlowInInterpolator();
    private boolean mIsAnimatingOut=false;

    public ScrollAwareFABBehaviorss(Context context, AttributeSet attrs){
        super();
    }
    @Override
                ...
                .setInterpolator(INTERPOLATOR).withLayer()
                    .setListener(new ViewPropertyAnimatorListener() {
                        ...
                        public void onAnimationStart(View view) {
                            ScrollAwareFABBehaviorss.this.mIsAnimatingOut=true;
                        }

                        @Override
                        public void onAnimationEnd(View view) {
                            ScrollAwareFABBehaviorss.this.mIsAnimatingOut=false;
